...
// Date: 2/14/25
// Definition of the ChessBox class now using LinkedBox containers
...
class ChessBox {
    private:
        ...
        LinkedBox<ChessPiece> P1_BOX_;       // Box for Player 1's pieces
        LinkedBox<ChessPiece> P2_BOX_;       // Box for Player 2's pieces
